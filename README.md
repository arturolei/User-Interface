...
* Open the code with your preferred integrated development environment (IDE). X (*Is Atom okay? It's not IDE but okay*)

* Start on the objectives X
...
- [X] Go to your [index.html](great-idea-website/index.html) file and build out your HTML structure.
...
- [X] Style your HTML using the [desktop design file](design-files/desktop.jpg) as a visual guide.
